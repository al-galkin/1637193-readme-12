...
$user_name = 'Александр'; // указал здесь свое имя

//массив с данными для показа карточки одного поста
$posts = [
    [
        'title' => 'Цитата',
        'type' => 'post-quote',
        ...
        <div class="popular__posts">
            <?php foreach ($posts as $post): ?>
                <article class="popular__post post <?= $post['type']; ?>">
                    ...
                    <div class="post__main"><!--содержимое карточки-->
                        ...
                        <?php elseif ($post['type'] === 'post-photo'): ?>
                            ...
                            <div class="post-photo__image-wrapper">
                                <img src="img/<?= $post['content']; ?>" alt="Фото от пользователя <?= $post['name']; ?>"
                        ...
                        <?php elseif ($post['type'] === 'post-video'): ?>
                            ...
                            <div class="post-video__block">
                                <div class="post-video__preview">
                                    ...
                                    <img src="img/coast-medium.jpg" alt="Превью к видео <?= $post['title']; ?>"
                                         width="360"
                                         height="188">
                                </div>
                        ...
                        <?php elseif ($post['type'] === 'post-link'): ?>
                            ...
                            <div class="post-link__wrapper">
                                <a class="post-link__external" href="http://<?= $post['content']; ?>"
                                   title="Перейти по ссылке <?= $post['title']; ?>">
                        ...
                        <div class="post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name"><!--имя пользоателя--><?= $post['name']; ?></b>
